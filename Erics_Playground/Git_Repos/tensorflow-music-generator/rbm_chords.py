...
print(sys.argv[1])
songs = get_songs((ABS_PTH + "Datasets/" + sys.argv[1]))  # These songs have already been converted from midi to msgpack
...
os.makedirs((ABS_PTH + "/Git_Repos/tensorflow-music-generator/Output_Chords/" + sys.argv[1] + "_Chords"))
with tf.Session() as sess:
    ...
    for i in range(sample.shape[0]):
        ...
        midi_manipulation.noteStateMatrixToMidi(S, "Output_Chords/" + sys.argv[1] + "_Chords" "/generated_chord_{}".format(i))
