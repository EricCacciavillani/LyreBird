...
shelf = shelve.open('/home/eric/Desktop/LyreBird/Main_Production/Saved_Weights/LSTM_Models/LSTM_Data_Dump/' + sys.argv[1] + '_Music_LSTM_Model')
...
shelf.close()
#
model = load_model('/home/eric/Desktop/LyreBird/Main_Production/Saved_Weights/LSTM_Models/' + sys.argv[1] + '_Music_LSTM_Model.h5')
...
# Let's generate a song of 100 Classical_Notes
...
for pattern in finalNotes:
    ...
    # increase offset each iteration so that Classical_Notes do not stack
    offset += 0.5
