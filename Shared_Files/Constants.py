...
ABS_PATHS = enum(PROJECT_ABSOLUTE_PATH=__PROJECT_ABSOLUTE_PATH,
                 ...
                 SAVED_MODELS_PATH=__PROJECT_ABSOLUTE_PATH + "/Data_Dump/Saved_Weights/",
                 SAVED_MODELS_PATH_LYREBIRD_TN=__PROJECT_ABSOLUTE_PATH + "/Data_Dump/Saved_Weights/LyreBird_TN",
                 SAVED_MODELS_PATH_LYREBIRD_TN_BEST=__PROJECT_ABSOLUTE_PATH + "/Data_Dump/Saved_Weights/LyreBird_TN_Best",
                 SAVED_WEIGHTS_PATH=__PROJECT_ABSOLUTE_PATH + "/Data_Dump/Saved_Weights/",
                 SAVED_NOTES_PATH=__PROJECT_ABSOLUTE_PATH + "/Data_Dump/Notes/",
